...
function Invoke-TryParseExactFormats {
    ...
    foreach ($entry in $formats) {
        $parsed = Get-Date -Year 1 -Month 1 -Day 1 -Hour 0 -Minute 0 -Second 0
...
function Invoke-TryParseSyslog {
    ...
    foreach ($fmt in $syslogFormats) {
        $result = Get-Date -Year 1 -Month 1 -Day 1 -Hour 0 -Minute 0 -Second 0
...
function Convert-Timestamp {
    ...
    process {
        ...
        $fallback = Get-Date -Year 1 -Month 1 -Day 1 -Hour 0 -Minute 0 -Second 0
